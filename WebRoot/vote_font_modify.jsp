...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/vote.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/js/Timer/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/js/Timer/dist/flatpickr.min.css" />
	<style>
	.alert{
		display:none;
		position:absolute;
					...
					<div class="pvote_area">
						...
						<div class="sponsor_area_box" style="">
							<div class="sponsorbox">
								...
								<div class="sb_title">
									<input type="text" value="${modifyVote.title }" placeholder="点击此处添加投票标题" class="sp_txttitle" maxlength="20" style="border: 1px dashed rgb(255, 0, 0); color: rgb(255, 0, 0);">
								</div>
								...
								<div class="sp_img_area" style="display: block;">
									<div class="img_infos">
										<div class="img_show"><img width="100%" height="100%" src="${modifyVote.imgUrl}"  class="show_upload_img" style="display: none;">
											<input type = "file" class="upload_file"/>
										</div>
										<div class="img_upp"><img src=""></div>
									</div>
									<div class="sp_explain_area">
										<div class="sp_explain_text">
											<textarea rows="" class="desc" cols="" maxlength="200" placeholder="关于此投票，你想说点啥..." value = "${modifyVote.desc }"></textarea>
										</div>
									</div>
									...
									<div class=""
										...
										<label><input type="radio" value="单选" name="select"/>单选</label> <label><input
											...
											<div class="sp_class_right" style="margin-left: 110px;margin-top: 0;">${modifyVote.classify }
											</div>
										<div class="clearfix"></div>
									</div>
									<div class="sp_time_area f-cb">
										<div class="sp_time_setup"><span class="sp_time_tip">截止时间：</span>
											<div class="setup_rowtxt">
												<input class='flatpickr' data-enable-time='true' value="${modifyVote.endTime }">
											</div>
										</div>
									</div>
									...
									<div class="sp_dict_area"><span class="sp_time_tip">关键字：</span> <input type="text" maxlength="126" class="sp_dict_txt" value="${modifyVote.key } ">
										<p class="sp_dict_tip">多个关键字请用半角“,”分开</p>
										<div class="clearfix"></div>
									</div>
									<div class="sp_submint_area"><input type="button" value="修改" class="sp_complate" data-vid ="${modifyVote.voteId }" 
									data-oid = "${modifyVote.optionsId }" ></div>
								</div>
							</div>
							<div class="tiplist">
